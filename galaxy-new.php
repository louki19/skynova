...
// HISTORY
/*
- Fixed the current planet system/galaxy
- Fixed the PHP_SELF value in template
- Fixed the max fleet available to move, including the officer
- Added the $_GET galaxy/system (for messages, overview, stats, alliance, etc)
*/

// TODO
/*
- Add the space for "exploration" mission
*/
?>