...
function MipAttack ($NbreMip, $IDAversaire) {
    $TechnoArme = doquery("SELECT * FROM {{table}} WHERE `id`='" .mysql_escape_string( $user['id'] ). "'", "users");
    $InfoAdversaire = doquery("SELECT * FROM {{table}} WHERE `id`='" . mysql_escape_string($IDAversaire ). "'", "planets", true);
...
*/
    ...
    $SqlDefenseur .= "`small_laser`='".mysql_escape_string($DefenseAdversaire[402])."', ";
    $SqlDefenseur .= "`big_laser`='".mysql_escape_string($DefenseAdversaire[403])."', ";
    $SqlDefenseur .= "`gauss_canyon`='".mysql_escape_string($DefenseAdversaire[404])."', ";
    $SqlDefenseur .= "`ionic_canyon`='".mysql_escape_string($DefenseAdversaire[405])."', ";
    $SqlDefenseur .= "`buster_canyon`='".mysql_escape_string($DefenseAdversaire[406])."', ";
    $SqlDefenseur .= "`small_protection_shield`='".mysql_escape_string($DefenseAdversaire[407])."', ";
    $SqlDefenseur .= "`big_protection_shield`='".mysql_escape_string($DefenseAdversaire[408])."' ";
    $SqlDefenseur .= " WHERE `id`='".mysql_escape_string($IDAversaire)."'";
